  ...
  /*  echo "Upload: " . $_FILES["file"]["name"] . "<br>";
    ...
    if (file_exists("NES/roms/" . $_FILES["file"]["name"]))
      ...
      "NES/roms/" . $_FILES["file"]["name"]);
		...
		// resize Image
		$ImageFileName = "NES/roms/".$_FILES["file"]["name"];
       ...
       // img.resize((maxWidth,height), Image.ANTIALIAS).save(output)
		$newWidth = 400;	// 400 for NES, 500 for SNES & GB covers
...
if ($counter == 0)
{
	...
	$exec = 'INSERT INTO games (game_title,md5,console) VALUES ("No Title Yet","'. $md5hash .'", "Nintendo Entertainment System")';		
...
<form action="nes_view.php?hash=<?php echo $md5hash ?>" method="post" enctype="multipart/form-data">
...
<?php
	...
	$ImgPathFile = "/NES/roms/".$ImageFile;
