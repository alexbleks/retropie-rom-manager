  ...
  /*  echo "Upload: " . $_FILES["file"]["name"] . "<br>";
    ...
    if (file_exists("GAMEBOY/roms/" . $_FILES["file"]["name"]))
      ...
      "GAMEBOY/roms/" . $_FILES["file"]["name"]);
		...
		// resize Image
		$ImageFileName = "GAMEBOY/roms/".$_FILES["file"]["name"];
...
if ($counter == 0)
{
	...
	$Console = "Game Boy";
	$exec = 'INSERT INTO games (game_title,md5,console) VALUES ("No Title Yet","'. $md5hash .'", "Game Boy")';					
	$go = $db->exec($exec);
...
<?php
	...
	$ImgPathFile = "/GAMEBOY/roms/".$ImageFile;
